...
- [x] **Sourcepos attributes:** Use Safari Web Inspector (Develop menu) to inspect WebView DOM, verify `data-sourcepos` on block elements
- [x] **Local images:** Reference `![](test-image.jpg)` in a .md file, verify it displays
